...
<html>
	<head>
		<title>Working Model-Pehchan</title>
...
?>
    ...
    <div class="container">  
        ...
        <div class="row">
            <div class="sm-col-12">
                <br>
                <i><b style="color:rgb(228, 88, 88); margin-left:70px;">Structure of CHILDLINE at the local level in any city/district </b></i>
                 <br>
                 <p style=" margin-left:70px;  margin-right:70px;">CHILDLINE functions through a network of NGOs, academic institutes,
                      the corporate sector and the allied systems. The focus of the service is to reach out to
                       every marginalized child and hence programmes must be designed accordingly</p>
            </div>
        </div>
